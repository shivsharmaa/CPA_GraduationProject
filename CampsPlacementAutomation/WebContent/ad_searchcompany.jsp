...
try{
	...
	ResultSet resultSet=st.executeQuery("select * from company2");
 while(resultSet.next()){
%>	
<tr>
<td><%=resultSet.getString("com_name") %></td>
<td><a href="search_company.jsp?com_name=<%=resultSet.getString("com_name") %>"><button type="button" class="delete">full detail</button></a></td>
<td><a href="delete_company2.jsp?com_name=<%=resultSet.getString("com_name") %>"><button type="button" class="delete">Delete</button></a></td>
</tr>
